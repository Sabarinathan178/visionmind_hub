  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-transparent position-absolute w-100">
      <div className="container">
        <Link className="navbar-brand text-dark" to="/">VisionMind</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarColor01">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <button type="button" className="btn btn-info" data-toggle="modal" data-target="#exampleModal">Sign Up</button>
            </li>
            {/* <li className="nav-item">
